...
import { getPreviewAvailability } from '@/lib/reservations/preview-store';
...
async function loadPublicClosureReason(venueId: string, localDate: string): Promise<string | null> {
...
export async function getAvailability(
  ...
  if (isReservationPreviewMode()) return getPreviewAvailability(request);
