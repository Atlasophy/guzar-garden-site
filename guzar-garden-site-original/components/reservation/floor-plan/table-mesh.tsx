...
export function TableMesh({ table, selected, reducedMotion, onSelect, onHover }: TableMeshProps) {
      ...
      <group ref={groupRef}>
        ...
        {selected ? (
          <mesh position={[0, 0.012, 0]} rotation={[-Math.PI / 2, 0, 0]}>
            <ringGeometry
              args={[
                Math.max(table.widthM, table.depthM) * 0.72,
                Math.max(table.widthM, table.depthM) * 0.82,
                40,
              ]}
            />
