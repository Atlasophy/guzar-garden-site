...
export async function uploadMenuImage(itemId: string, file: Buffer): Promise<StoredImage> {
 ...
 */
export async function attachImageToItem(itemId: string, stored: StoredImage): Promise<void> {
